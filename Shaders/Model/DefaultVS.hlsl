...
VSOutput main(VSInput vsInput)
{
	...
	vsOutput.position = mul(g_globalCB.ViewProjMatrix, float4(vsOutput.worldPos, 1.0));
	vsOutput.sunShadowCoord = mul(g_globalCB.SunShadowMatrix, float4(vsOutput.worldPos, 1.0)).xyz;
