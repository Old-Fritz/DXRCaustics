...
void RayGen()
{
	...
	float4 normalData =		g_GBNormal.Load(			int4(readGBufferAt, DispatchRaysIndex().z, 0));
	float2 reflectence =	g_GBMetallicRoughness.Load(	int4(readGBufferAt, DispatchRaysIndex().z, 0));
